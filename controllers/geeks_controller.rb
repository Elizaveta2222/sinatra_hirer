...
namespace '/api/v1' do
    ...
    # все соискатели, фильтр по имени и стеку
    get '/geeks' do
    ...
    # создать нового соискателя (POST)
    post '/geeks' do
        geek = Geek.create(params)
        geek.nil? ? [].to_json : geek.values.to_json
    end

    # все прочитанные заявления соискателя
    get '/geek_read_applies/:id' do
    ...
    # поиск данных одного соискателя 
    get '/geek/:id' do
